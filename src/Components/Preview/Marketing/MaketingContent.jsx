...
import Img from './marketingresumepfp.jpg'



function MaketingContent() {
    ...
    return (
        <div>
            <div className='flex w-full overflow-hidden border border-[#323B4C]'>
                <div className=' bg-[#323B4C] p-8 w-[35%] pt-14 '>
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className='border border-zinc-400 mt-[-1vw] ml-4 w-[215px]  '></div>
                        <div className='font-mono text-white ml-4 mt-'>
                            <h5>Phone</h5>
                            <p className='text-zinc-400 mt-[-5px] text-[13px]'>{data.phone ? data.phone : "+91 123-456-789"}</p>
                        </div>
                        <div className='font-mono text-white ml-4 mt-'>
                            <h5>Email</h5>
                            <p className='text-zinc-400 text-[13px] mt-[-5px]'>{data.email ? data.email : "xyz@reallyagoodmail.com ."}</p>
                        </div>
                        {data.website && (
                            <div className='font-mono text-white ml-4 mt-'>
                                <h5>Website</h5>
                        ...
                        <div>
                            {(data.education !== null && Object.keys(data.education).length > 0) && (
                                <div className='resume-paragraph ml-4 '>
                                    <h4 className='font-semibold font-mono text-white text-[15px]'>{data.education.title || edu[0].title}</h4>
                                            ...
                                            <div className='flex-col space-y-1 mt-[-1.2vw] ml-4 text-[2vh]'>
                                                {data.educations.map((edu) => (
                                                    <div key={edu.id} className='resume-paragraph'>
                                                        <h4 className='font-semibold font-mono text-white text-[15px]'>{edu.title}</h4>
                        ...
                        <div>
                            {(data.activity !== null && Object.keys(data.activity).length > 0) && (
                                <div>
                                    <div className='ml-4'>
                                        <h2 className='resume-heading1  font-mono text-white text-[22px]  tracking-[2px]'>Extracurricular Activities</h2>
                                        <div className='border border-zinc-400 mt-[0.5vw]  w-[215px]  '></div>
                                        <div className='flex-col space-y-1 mt-6 text-[2vh]'>
                                            <div className='resume-paragraph mt'>
                                                <h4 className='font-semibold font-mono text-white text-[15px]'>{data.activity.title || acti[0].title}</h4>
                                                <p className='text-white font-mono text-[13px]'>{data.activity.description || acti[0].description} </p>
                                                ...
                                                <div key={act.id}>
                                                    <div className='flex-col space-y-1 mt-6 text-[2vh]'>
                                                        <div className='resume-paragraph'>
                                                            <h4 className='font-semibold font-mono text-white text-[15px]'>{act.title}</h4>
                                                            <p className='text-white font-mono text-[13px]'>{act.description} </p>
                ...
                <div className='p-8 pr-10 pt-14'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <div className=' leading-tight text-zinc-600 text-[13px] overflow-hidden text-wrap'>
                        ...
                        <div>
                            {(data.tech !== null && Object.keys(data.tech).length > 0) && (
                                <div>
                                    <div className=' mt-2 '>
                                        <h2 className='resume-heading1 font-bold font-mono tracking-wider uppercase text-[#323B4C] text-[24px]'>Experties</h2>
                                        <p className='text-zinc-600 text-[13px]'>{data.tech.skill || skills[0].skill}</p>
                                            ...
                                            {data.techs.map((tech) => (
                                                <div key={tech.id} className='flex'>
                                                    <div className='flex gap-5  '>
                                                        <p className='flex text-zinc-600 text-[13px]'>{tech.skill}</p>
                                                    </div>
...
export default MaketingContent
